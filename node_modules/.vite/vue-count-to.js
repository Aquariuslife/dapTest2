...
var require_vue_count_to_min = __commonJS((exports, module) => {
  !function(t, e) {
    typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define("CountTo", [], e) : typeof exports == "object" ? exports.CountTo = e() : t.CountTo = e();
  }(exports, function() {
    return function(t) {
      function e(n) {
        if (i[n])
      ...
      e.default = a.default, typeof window != "undefined" && window.Vue && window.Vue.component("count-to", a.default);
    }, function(t, e, i) {
      "use strict";
      Object.defineProperty(e, "__esModule", {value: true});
      ...
      if (typeof window == "undefined")
        ...
        r && o || (e.requestAnimationFrame = r = function(t2) {
          var e2 = new Date().getTime(), i2 = Math.max(0, 16 - (e2 - n)), a2 = window.setTimeout(function() {
            t2(e2 + i2);
          }, i2);
          return n = e2 + i2, a2;
      ...
      t.exports = function(t2, e2, i, n) {
        ...
        o !== "object" && o !== "function" || (a = t2, r = t2.default);
...
// dep:vue-count-to
var vue_count_to_default = require_vue_count_to_min();
export {
  vue_count_to_default as default
};

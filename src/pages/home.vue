  ...
  <div class="home-page">
    <div class="h-header">
      ...
      <div class="h-header__nav">
        <router-link class="h-header__navItem" to="/home-container"><SvgIcon svg-name="greenhouse" :width="16" :height="16" style="margin-right: 8px"></SvgIcon>大棚信息管理</router-link>
